    ...
    def run(self, state: RunState) -> RunState:
        ...
        report = {
            "summary": {
                ...
                "generation_iteration_monitor_count": len(state.generation_iteration_monitor or []),
            ...
            "generation_iteration_queue": state.generation_iteration_queue or [],
            "generation_iteration_manifest": state.generation_iteration_manifest or {},
            "generation_iteration_submissions": state.generation_iteration_submissions or [],
            "generation_iteration_execution": state.generation_iteration_execution or [],
            "generation_iteration_monitor": state.generation_iteration_monitor or [],
            "generation_iteration_reingest_manifest": state.generation_iteration_reingest_manifest or {},
            ...
            "artifacts": {
                ...
                "generation_iteration_queue_path": str(state.run_dir / "generation_iteration_queue.json"),
                "generation_iteration_manifest_path": str(state.run_dir / "generation_iteration_manifest.json"),
                "genmol_iteration_input_path": str(state.run_dir / "genmol_iteration_input.json"),
                "generation_iteration_launch_manifest_path": str(state.run_dir / "generation_iteration_launch_manifest.json"),
                "generation_iteration_submissions_path": str(state.run_dir / "generation_iteration_submissions.json"),
                "generation_iteration_launcher_script_path": str(state.run_dir / "launch_genmol_iteration.sh"),
                "generation_iteration_execution_path": str(state.run_dir / "generation_iteration_execution.json"),
                ...
                "generation_iteration_loop_summary_path": str(state.run_dir / "generation_iteration_loop_summary.json"),
