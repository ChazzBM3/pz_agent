...
def test_infer_figure_candidates_uses_pdf_and_figure_hints() -> None:
    document = {
        "candidate_id": "cand_1",
        "document_kind": "pdf",
        ...
        "trusted_host": True,
        "local_artifact_path": "artifacts/page_assets/cand_1/doc.pdf",
        "metadata_path": "artifacts/page_assets/cand_1/doc.json",
        ...
        "documents": [
            {
                ...
                "snippet": "Figure 1",
                "trusted_host": True,
                "local_artifact_path": str(tmp_path / "doc.pdf"),
